<?php return array (
  ...
  array (
    ...
    array (
      ...
      'index.html' => '网站首页',
      'list.html' => '列表页',
      'list_chaoliusp.html' => '潮流商品列表页',
      'list_download.html' => '下载列表页',
      'list_gongsijs.html' => '公司介绍列表页',
      'list_lianxiwm.html' => '联系我们列表页',
      'list_meitibd.html' => '媒体报道列表页',
      'list_picture.html' => '图片列表页',
      'list_rencaizp.html' => '人才招聘列表页',
      'list_zoujinbl.html' => '走进缤利列表页',
      'message.html' => '消息提示页',
      'page.html' => '单网页',
      'rss.html' => 'RSS页',
      'search.html' => '搜索',
